...
with open('/media/zhaoyibin/common/3DRE/3DGS/taichi_3d_gaussian_splatting_complex/result/real_camera/csv/3DGS.txt', 'r') as file:
    content = file.read()
GS = []
...
with open('/media/zhaoyibin/common/3DRE/3DGS/taichi_3d_gaussian_splatting_complex/result/real_camera/csv/colmap.txt', 'r') as file:
    content = file.read()
colmap = []
for i in content.split("\n"):
    if i =='':
...
with open('/home/zhaoyibin/3DRE/3DGS/taichi_3d_gaussian_splatting_complex/result/real_camera/csv/ours.txt', 'r') as file:
    content = file.read()
ours = []
for i in content.split("\n"):
    if i =='':
...
with open('/home/zhaoyibin/3DRE/3DGS/taichi_3d_gaussian_splatting_complex/result/real_camera/csv/apperance.txt', 'r') as file:
    content = file.read()
apperance = []
for i in content.split("\n"):
    if i =='':
...
with open('/home/zhaoyibin/3DRE/3DGS/taichi_3d_gaussian_splatting_complex/result/real_camera/csv/2DGS.txt', 'r') as file:
    content = file.read()
GS2D = []
for i in content.split("\n"):
    if i =='':
...
with open('/home/zhaoyibin/3DRE/3DGS/taichi_3d_gaussian_splatting_complex/result/real_camera/csv/lightinstance.txt', 'r') as file:
    content = file.read()
GS_lightinstance = []
for i in content.split("\n"):
    if i =='':
