...
with open('/media/zhaoyibin/common/3DRE/3DGS/taichi_3d_gaussian_splatting_complex/result/real_camera_2/csv/3dgs.txt', 'r') as file:
    content = file.read()
GS = []
...
with open('/media/zhaoyibin/common/3DRE/3DGS/taichi_3d_gaussian_splatting_complex/result/real_camera_2/csv/colmap.txt', 'r') as file:
    content = file.read()
colmap = []
for i in content.split("\n"):
    if i =='':
...
with open('/home/zhaoyibin/3DRE/3DGS/taichi_3d_gaussian_splatting_complex/result/real_camera_2/csv/ours.txt', 'r') as file:
    content = file.read()
ours = []
for i in content.split("\n"):
    if i =='':
    ...
    if float(i.split()[-1])<xiajie:
        ours.append(xiajie)
        continue
    ours.append(float(i.split()[-1]))
ours = np.array(ours)
print("ours error：",ours.mean(),"ours std：",ours.std())
all_data.append(ours)

with open('/home/zhaoyibin/3DRE/3DGS/taichi_3d_gaussian_splatting_complex/result/real_camera_2/csv/apperance.txt', 'r') as file:
    content = file.read()
apperance = []
for i in content.split("\n"):
    if i =='':
...
with open('/home/zhaoyibin/3DRE/3DGS/taichi_3d_gaussian_splatting_complex/result/real_camera_2/csv/2dgs.txt', 'r') as file:
    content = file.read()
GS2D = []
for i in content.split("\n"):
    if i =='':
...
with open('/home/zhaoyibin/3DRE/3DGS/taichi_3d_gaussian_splatting_complex/result/real_camera_2/csv/lightinstance.txt', 'r') as file:
    content = file.read()
GS_lightinstance = []
for i in content.split("\n"):
    if i =='':
...
# combined_df = pd.concat([data_pd_colmap,data_pd_ours], axis=1)
