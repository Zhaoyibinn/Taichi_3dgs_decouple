# taichi_3d_gaussian_splatting_decoupled

Fork of taichi_3d_gaussian_splatting. Add decoupled model to solve different light and bad light.
...
- config BlenderNerf: make sure Train is selected and Test is not selected(Test seems to be buggy), File Format is NGP, save path is filled.![image](images/blendernerf_config_0.png)
- config BlenderNerf Camera on Sphere: follow BlenderNerf README to config the camera(default is enough for most case). Then click PLAY COS.![image](images/blender_nerf_config_1.png)
