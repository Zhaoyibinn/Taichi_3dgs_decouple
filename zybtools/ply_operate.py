...
class plyclass:
    ...
    def load_ply( self, instance=False):
        ...
        scale =np.array([np.asarray(plydata.elements[0]["scale_0"]),np.asarray(plydata.elements[0]["scale_1"]),np.asarray(plydata.elements[0]["scale_2"])])
        ...
        for i in range(points_num):
            ...
            if (features_dc_1).mean()<=-1.7724538:
                black_idx.append(i)
...
ply_path = "/home/zhaoyibin/3DRE/3DGS/taichi_3d_gaussian_splatting_complex/logs/save_offical&sigmod/S3_TANGO/apperance/scene_29000.ply"
ply_path_trans = "/home/zhaoyibin/3DRE/3DGS/taichi_3d_gaussian_splatting_complex/logs/save_offical&sigmod/S3_TANGO/apperance/scene_29000_trans.ply"
