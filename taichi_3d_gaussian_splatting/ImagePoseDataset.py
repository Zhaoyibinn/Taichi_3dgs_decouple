...
class ImagePoseDataset(torch.utils.data.Dataset):
    ...
    def __init__(self, dataset_json_path: str):
        ...
        required_columns = ["image_path", "T_pointcloud_camera",
                            "camera_intrinsics", "camera_height", "camera_width", "camera_id","idx"]
    ...
    def _autoscale_image_and_camera_info(image: torch.Tensor, camera_info: CameraInfo):
        ...
        image = transforms.functional.resize(image, size=800, max_size=MAX_RESOLUTION_TRAIN, antialias=True)
    ...
    def __getitem__(self, idx):
        ...
        return image, q_pointcloud_camera, t_pointcloud_camera, camera_info,index
